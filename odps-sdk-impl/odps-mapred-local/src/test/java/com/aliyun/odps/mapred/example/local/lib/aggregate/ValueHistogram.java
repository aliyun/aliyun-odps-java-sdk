...
/**
 * This class implements a value aggregator that computes the histogram of a
 * sequence of strings.
 */
public class ValueHistogram implements ValueAggregator {
   ...
   *
   * @param val
   *     the value to be added. It is expected to be a string in the form
   *     of xxxx\tnum, meaning xxxx has num occurrences.
   */
  ...
  /**
   * @return the string representation of this aggregator. It includes the
   * following basic statistics of the histogram: the number of unique
   * values the minimum value the media value the maximum value the
  ...
  /**
   * @return a string representation of the list of value/frequence pairs of the
   * histogram
   */
  ...
  /**
   * @return a list value/frequence pairs. The return value is expected to be
   * used by the reducer.
   */
