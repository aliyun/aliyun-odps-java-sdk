...
/* harmony import */ var dayjs_plugin_isoWeek_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9542);
/* harmony import */ var dayjs_plugin_customParseFormat_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(285);
/* harmony import */ var dayjs_plugin_advancedFormat_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(8734);
/* harmony import */ var _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(6447);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(4218);
...
const getStartDate = function(prevTime, dateFormat2, str) {
  ...
  if (mDate.isValid()) {
    ...
    _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_7__.l.debug("Invalid date:" + str);
    _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_7__.l.debug("With date format:" + dateFormat2.trim());
...
const setLink = function(ids, _linkStr) {
  ...
  if ((0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_7__.c)().securityLevel !== "loose") {
...
const setClickFun = function(id, functionName, functionArgs) {
  ...
  if (rawTask !== void 0) {
    pushFun(id, () => {
      _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_7__.u.runFunc(functionName, ...argList);
    });
  }
};
...
const ganttDb = {
  getConfig: () => (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_7__.c)().gantt,
  clear,
  setDateFormat,
  getDateFormat,
  ...
  setDiagramTitle: _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_7__.q,
  getDiagramTitle: _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_7__.t,
  setDisplayMode,
  getDisplayMode,
...
const setConf = function() {
  _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_7__.l.debug("Something is calling, setConf, remove the call");
};
...
const draw = function(text, id, version, diagObj) {
  const conf = (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_7__.c)().gantt;
  ...
  (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_7__.i)(svg, h, w, conf.useMaxWidth);
  ...
  function drawRects(theArray, theGap, theTopPad, theSidePad, theBarHeight, theColorScale, w2) {
    ...
    const securityLevel2 = (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_7__.c)().securityLevel;
  ...
  function drawExcludeDays(theGap, theTopPad, theSidePad, w2, h2, tasks2, excludes2, includes2) {
    ...
    if (dayjs__WEBPACK_IMPORTED_MODULE_1__(maxTime).diff(dayjs__WEBPACK_IMPORTED_MODULE_1__(minTime), "year") > 5) {
      _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_7__.l.warn(
  ...
  function vertLabels(theGap, theTopPad) {
    ...
    svg.append("g").selectAll("text").data(numOccurrences).enter().append(function(d) {
      const rows = d[0].split(_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_7__.e.lineBreakRegex);
