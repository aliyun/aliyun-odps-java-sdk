...
const findOrCreateNode = (ID) => {
  ID = mermaid_6dc72991.e.sanitizeText(ID, (0,mermaid_6dc72991.c)());
  if (!nodesMap[ID]) {
...
const db = {
  nodesMap,
  getConfig: () => (0,mermaid_6dc72991.c)().sankey,
  getNodes,
  getLinks,
  getGraph,
  addLink,
...
const draw = function(text, id, _version, diagObj) {
  const { securityLevel, sankey: conf } = (0,mermaid_6dc72991.c)();
  const defaultSankeyConfig = mermaid_6dc72991.K.sankey;
  let sandboxElement;
...
${prefix}${Math.round(value * 100) / 100}${suffix}`;
  ...
  (0,mermaid_6dc72991.o)(void 0, svg, 0, useMaxWidth);
};
const renderer = {
  draw
};
