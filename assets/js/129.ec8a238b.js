...
/* harmony export */ });
/* harmony import */ var _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6447);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4218);
/* harmony import */ var _svgDrawCommon_5e1cfd1d_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(3789);
...
/* harmony import */ var dompurify__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(2424);
...
const autoWrap = () => {
  ...
  return (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.c)().sequence.wrap;
};
...
const parseMessage = function(str) {
  ...
  _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("parseMessage:", message);
  return message;
};
const parseBoxData = function(str) {
  ...
  return {
    color,
    text: title !== void 0 ? (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.d)(title.replace(/^:?(?:no)?wrap:/, ""), (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.c)()) : void 0,
...
const addLinks = function(actorId, text) {
  ...
  try {
    let sanitizedText = (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.d)(text.text, (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.c)());
    sanitizedText = sanitizedText.replace(/&amp;/g, "&");
    sanitizedText = sanitizedText.replace(/&equals;/g, "=");
    const links = JSON.parse(sanitizedText);
    insertLinks(actor, links);
  } catch (e) {
    _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.l.error("error while parsing actor link text", e);
  }
};
...
const addProperties = function(actorId, text) {
  ...
  try {
    ...
    _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.l.error("error while parsing actor properties text", e);
  }
};
...
const addDetails = function(actorId, text) {
  ...
  try {
    ...
    _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.l.error("error while parsing actor details text", e);
  }
};
  ...
  if (Array.isArray(param)) {
    ...
    switch (param.type) {
      ...
      case "altEnd":
        ...
        break;
      case "setAccTitle":
        (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.s)(param.text);
        break;
      case "parStart":
...
const db = {
  ...
  getConfig: () => (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.c)().sequence,
  clear,
  parseMessage,
  parseBoxData,
  LINETYPE,
...
const drawKatex = async function(elem, textData, msgModel = null) {
  ...
  const lines = await (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.r)(textData.text, (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.F)());
...
const drawText = function(elem, textData) {
  ...
  let textHeight = 0;
  const lines = textData.text.split(_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.lineBreakRegex);
  const [_textFontSize, _textFontSizePx] = (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.D)(textData.fontSize);
  let textElems = [];
  let dy = 0;
  ...
  for (let [i, line] of lines.entries()) {
    ...
    const text = line || _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.Z;
    if (textData.tspan) {
...
const drawActorTypeParticipant = async function(elem, actor, conf2, isFooter) {
  ...
  if (actor.properties != null && actor.properties["icon"]) {
    ...
    if (iconSrc.charAt(0) === "@") {
      (0,_svgDrawCommon_5e1cfd1d_js__WEBPACK_IMPORTED_MODULE_5__.b)(g, rect.x + rect.width - 20, rect.y + 10, iconSrc.substr(1));
    } else {
      (0,_svgDrawCommon_5e1cfd1d_js__WEBPACK_IMPORTED_MODULE_5__.c)(g, rect.x + rect.width - 20, rect.y + 10, iconSrc);
    }
  }
  await _drawTextCandidateFunc(conf2, (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.G)(actor.description))(
    actor.description,
    g,
    rect.x,
    rect.y,
...
const drawLoop = async function(elem, loopModel, labelText, conf2) {
  ...
  let txt = (0,_svgDrawCommon_5e1cfd1d_js__WEBPACK_IMPORTED_MODULE_5__.e)();
  txt.text = labelText;
  ...
  txt.fontWeight = fontWeight;
  txt.wrap = true;
  let textElem = (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.G)(txt.text) ? await drawKatex(g, txt, loopModel) : drawText(g, txt);
  if (loopModel.sectionTitles !== void 0) {
    for (const [idx, item] of Object.entries(loopModel.sectionTitles)) {
      if (item.message) {
        ...
        if ((0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.G)(txt.text)) {
...
const _drawTextCandidateFunc = function() {
  ...
  function byTspan(content, g, x, y, width, height, textAttrs, conf2) {
    ...
    const [_actorFontSize, _actorFontSizePx] = (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.D)(actorFontSize);
    const lines = content.split(_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.lineBreakRegex);
  ...
  async function byKatex(content, g, x, y, width, height, textAttrs, conf2) {
    const dim = await (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.H)(content, (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.F)());
    const s = g.append("switch");
    ...
    text.append("div").style("text-align", "center").style("vertical-align", "middle").html(await (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.r)(content, (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.F)()));
    byTspan(content, s, x, y, width, height, textAttrs, conf2);
    _setTextAttrs(text, textAttrs);
  }
...
const bounds = {
  ...
  init: function() {
    ...
    this.verticalPos = 0;
    setConf((0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.c)());
  },
  ...
  insert: function(startx, starty, stopx, stopy) {
    const _startx = _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.getMin(startx, stopx);
    const _stopx = _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(startx, stopx);
    const _starty = _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.getMin(starty, stopy);
    const _stopy = _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(starty, stopy);
  ...
  bumpVerticalPos: function(bump) {
    ...
    this.data.stopy = _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(this.data.stopy, this.verticalPos);
  },
...
const drawNote = async function(elem, noteModel) {
  ...
  const textObj = (0,_svgDrawCommon_5e1cfd1d_js__WEBPACK_IMPORTED_MODULE_5__.e)();
  ...
  const textElem = (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.G)(textObj.text) ? await drawKatex(g, textObj) : drawText(g, textObj);
...
async function boundMessage(_diagram, msgModel) {
  ...
  const lines = _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.splitBreaks(message).length;
  const isKatexMsg = (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.G)(message);
  const textDims = isKatexMsg ? await (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.H)(message, (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.c)()) : _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.u.calculateTextDimensions(message, messageFont(conf));
  if (!isKatexMsg) {
  ...
  if (startx === stopx) {
    ...
    totalOffset += 30;
    const dx = _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(textWidth / 2, conf.width / 2);
    bounds.insert(
      startx - dx,
...
const drawMessage = async function(diagram2, msgModel, lineStartY, diagObj) {
  ...
  const textDims = _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.u.calculateTextDimensions(message, messageFont(conf));
  const textObj = (0,_svgDrawCommon_5e1cfd1d_js__WEBPACK_IMPORTED_MODULE_5__.e)();
  textObj.x = startx;
  textObj.y = starty + 10;
  ...
  textObj.tspan = false;
  (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.G)(textObj.text) ? await drawKatex(diagram2, textObj, { startx, stopx, starty: lineStartY }) : drawText(diagram2, textObj);
  const textWidth = textDims.width;
  let line;
  if (startx === stopx) {
    if (conf.rightAngles) {
      line = diagram2.append("path").attr(
        "d",
        `M  ${startx},${lineStartY} H ${startx + _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(conf.width / 2, textWidth / 2)} V ${lineStartY + 25} H ${startx}`
      );
    } else {
      line = diagram2.append("path").attr(
        "d",
...
const addActorRenderingData = async function(diagram2, actors, createdActors, actorKeys, verticalPos, messages, isFooter) {
  ...
  for (const actorKey of actorKeys) {
    ...
    actor.height = _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(actor.height || conf.height, conf.height);
    actor.margin = actor.margin || conf.actorMargin;
    maxHeight = _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(maxHeight, actor.height);
...
const drawActors = async function(diagram2, actors, actorKeys, isFooter) {
  if (!isFooter) {
    ...
    for (const actorKey of actorKeys) {
      ...
      maxHeight = _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(maxHeight, height);
    }
...
const setConf = function(cnf) {
  (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.f)(conf, cnf);
  if (cnf.fontFamily) {
...
const activationBounds = function(actor, actors) {
  ...
  const left = activations.reduce(function(acc, activation) {
    return _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.getMin(acc, activation.startx);
  }, actorObj.x + actorObj.width / 2 - 1);
  const right = activations.reduce(function(acc, activation) {
    return _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(acc, activation.stopx);
  }, actorObj.x + actorObj.width / 2 + 1);
  return [left, right];
};
function adjustLoopHeightForWrap(loopWidths, msg, preMargin, postMargin, addLoopFn) {
  ...
  if (msg.id && msg.message && loopWidths[msg.id]) {
    ...
    msg.message = _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.u.wrapLabel(`[${msg.message}]`, loopWidth - 2 * conf.wrapPadding, textConf);
    msg.width = loopWidth;
    msg.wrap = true;
    const textDims = _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.u.calculateTextDimensions(msg.message, textConf);
    const totalOffset = _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(textDims.height, conf.labelBoxHeight);
    heightAdjust = postMargin + totalOffset;
    _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.l.debug(`${totalOffset} - ${msg.message}`);
  }
  addLoopFn(msg);
...
const draw = async function(_text, id, _version, diagObj) {
  const { securityLevel, sequence } = (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.c)();
  conf = sequence;
  let sandboxElement;
  ...
  bounds.init();
  _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.l.debug(diagObj.db);
    ...
    switch (msg.type) {
      ...
      default:
        try {
          ...
          _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.l.error("error while drawing message", e);
        }
    }
    if ([
  ...
  _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("createdActors", createdActors);
  _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("destroyedActors", destroyedActors);
  ...
  (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.i)(diagram2, height, width, conf.useMaxWidth);
  const extraVertForTitle = title ? 40 : 0;
  diagram2.attr(
    "viewBox",
    box.startx - conf.diagramMarginX + " -" + (conf.diagramMarginY + extraVertForTitle) + " " + width + " " + (height + extraVertForTitle)
  );
  _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.l.debug(`models:`, bounds.models);
};
async function getMaxMessageWidthPerActor(actors, messages, diagObj) {
  ...
  for (const msg of messages) {
    if (actors[msg.to] && actors[msg.from]) {
      ...
      const wrappedMessage = msg.wrap ? _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.u.wrapLabel(msg.message, conf.width - 2 * conf.wrapPadding, textFont) : msg.message;
      const messageDimensions = (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.G)(wrappedMessage) ? await (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.H)(msg.message, (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.c)()) : _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.u.calculateTextDimensions(wrappedMessage, textFont);
      const messageWidth = messageDimensions.width + 2 * conf.wrapPadding;
      if (isMessage && msg.from === actor.nextActor) {
        maxMessageWidthPerActor[msg.to] = _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(
          maxMessageWidthPerActor[msg.to] || 0,
          messageWidth
        );
      } else if (isMessage && msg.from === actor.prevActor) {
        maxMessageWidthPerActor[msg.from] = _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(
        ...
        maxMessageWidthPerActor[actor.prevActor] = _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(
  ...
  _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("maxMessageWidthPerActor:", maxMessageWidthPerActor);
...
const getRequiredPopupWidth = function(actor) {
  ...
  for (const key in actor.links) {
    const labelDimensions = _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.u.calculateTextDimensions(key, textFont);
...
async function calculateActorMargins(actors, actorToMessageWidth, boxes) {
  ...
  for (const prop of Object.keys(actors)) {
    ...
    if (actor.wrap) {
      actor.description = _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.u.wrapLabel(
        actor.description,
    ...
    actor.width = actor.wrap ? conf.width : _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(conf.width, actDims.width + 2 * conf.wrapPadding);
    actor.height = actor.wrap ? _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(actDims.height, conf.height) : conf.height;
    maxHeight = _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(maxHeight, actor.height);
  }
  for (const actorKey in actorToMessageWidth) {
    ...
    if (!nextActor) {
      ...
      actor.margin = _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(actorWidth2, conf.actorMargin);
      continue;
    }
    const messageWidth = actorToMessageWidth[actorKey];
    const actorWidth = messageWidth + conf.actorMargin - actor.width / 2 - nextActor.width / 2;
    actor.margin = _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(actorWidth, conf.actorMargin);
  }
  let maxBoxHeight = 0;
  boxes.forEach((box) => {
    ...
    if (box.wrap) {
      box.name = _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.u.wrapLabel(box.name, totalWidth - 2 * conf.wrapPadding, textFont);
    }
    const boxMsgDimensions = _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.u.calculateTextDimensions(box.name, textFont);
    maxBoxHeight = _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(boxMsgDimensions.height, maxBoxHeight);
    const minWidth = _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(totalWidth, boxMsgDimensions.width + 2 * conf.wrapPadding);
  ...
  return _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(maxHeight, conf.height);
}
const buildNoteModel = async function(msg, actors, diagObj) {
  const startx = actors[msg.from].x;
  const stopx = actors[msg.to].x;
  const shouldWrap = msg.wrap && msg.message;
  let textDimensions = (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.G)(msg.message) ? await (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.H)(msg.message, (0,_mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.c)()) : _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.u.calculateTextDimensions(
    shouldWrap ? _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.u.wrapLabel(msg.message, conf.width, noteFont(conf)) : msg.message,
    noteFont(conf)
  );
  const noteModel = {
    width: shouldWrap ? conf.width : _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(conf.width, textDimensions.width + 2 * conf.noteMargin),
    height: 0,
  ...
  if (msg.placement === diagObj.db.PLACEMENT.RIGHTOF) {
    noteModel.width = shouldWrap ? _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(conf.width, textDimensions.width) : _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(
      actors[msg.from].width / 2 + actors[msg.to].width / 2,
      textDimensions.width + 2 * conf.noteMargin
    );
    noteModel.startx = startx + (actors[msg.from].width + conf.actorMargin) / 2;
  } else if (msg.placement === diagObj.db.PLACEMENT.LEFTOF) {
    noteModel.width = shouldWrap ? _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(conf.width, textDimensions.width + 2 * conf.noteMargin) : _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(
      actors[msg.from].width / 2 + actors[msg.to].width / 2,
      textDimensions.width + 2 * conf.noteMargin
    );
    noteModel.startx = startx - noteModel.width + (actors[msg.from].width - conf.actorMargin) / 2;
  } else if (msg.to === msg.from) {
    textDimensions = _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.u.calculateTextDimensions(
      shouldWrap ? _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.u.wrapLabel(
        msg.message,
        _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(conf.width, actors[msg.from].width),
        noteFont(conf)
      ) : msg.message,
      noteFont(conf)
    );
    noteModel.width = shouldWrap ? _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(conf.width, actors[msg.from].width) : _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(
  ...
  if (shouldWrap) {
    noteModel.message = _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.u.wrapLabel(
      msg.message,
...
const buildMessageModel = function(msg, actors, diagObj) {
  ...
  if (msg.wrap && msg.message) {
    msg.message = _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.u.wrapLabel(
      msg.message,
      _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(boundedWidth + 2 * conf.wrapPadding, conf.width),
      messageFont(conf)
    );
  }
  const msgDims = _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.u.calculateTextDimensions(msg.message, messageFont(conf));
  return {
    width: _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(
...
const calculateLoopBounds = async function(messages, actors, _maxWidthPerActor, diagObj) {
  ...
  for (const msg of messages) {
    msg.id = _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.u.random({ length: 10 });
    switch (msg.type) {
      case diagObj.db.LINETYPE.LOOP_START:
      case diagObj.db.LINETYPE.ALT_START:
      case diagObj.db.LINETYPE.OPT_START:
    ...
    if (isNote) {
      ...
      stack.forEach((stk) => {
        current = stk;
        current.from = _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.getMin(current.from, noteModel.startx);
        current.to = _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(current.to, noteModel.startx + noteModel.width);
        current.width = _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(current.width, Math.abs(current.from - current.to)) - conf.labelBoxWidth;
      });
    } else {
      ...
      if (msgModel.startx && msgModel.stopx && stack.length > 0) {
        stack.forEach((stk) => {
          ...
          if (msgModel.startx === msgModel.stopx) {
            ...
            current.from = _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.getMin(
              from.x - msgModel.width / 2,
              from.x - from.width / 2,
              current.from
            );
            current.to = _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(
              to.x + msgModel.width / 2,
              to.x + from.width / 2,
              current.to
            );
            current.width = _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(current.width, Math.abs(current.to - current.from)) - conf.labelBoxWidth;
          } else {
            current.from = _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.getMin(msgModel.startx, current.from);
            current.to = _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(msgModel.stopx, current.to);
            current.width = _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.e.getMax(current.width, msgModel.width) - conf.labelBoxWidth;
          }
        });
      }
    }
  ...
  bounds.activations = [];
  _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Loop type widths:", loops);
  return loops;
};
const renderer = {
  bounds,
...
/* harmony import */ var _mermaid_6dc72991_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6447);
