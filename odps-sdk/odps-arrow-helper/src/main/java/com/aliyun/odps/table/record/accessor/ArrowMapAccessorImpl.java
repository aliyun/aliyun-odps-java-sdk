...
public class ArrowMapAccessorImpl {
    ...
    public static class ArrowMapAccessorForRecord extends ArrowMapAccessor<Map<Object, Object>> {
        ...
        private final boolean encodeString;
        ...
        public ArrowMapAccessorForRecord(MapVector mapVector, TypeInfo typeInfo, boolean isExtension, boolean encodeString) {
            super(mapVector);
            ...
            this.keyAccessor = ArrowToRecordConverter.createColumnVectorAccessor(
                    entries.getChild(MapVector.KEY_NAME), keyTypeInfo, isExtension, encodeString);
            this.valueAccessor = ArrowToRecordConverter.createColumnVectorAccessor(
                    entries.getChild(MapVector.VALUE_NAME), valueTypeInfo, isExtension, encodeString);
        }
        ...
        protected Map<Object, Object> getMapData(int offset, int numElements) {
            ...
            try {
                for (int i = 0; i < numElements; i++) {
                    map.put(ArrowToRecordConverter.getData(keyAccessor, keyTypeInfo, offset + i, isExtension, encodeString),
                            ArrowToRecordConverter.getData(valueAccessor, valueTypeInfo, offset + i, isExtension, encodeString));
                }
                return map;
            } catch (Exception e) {
