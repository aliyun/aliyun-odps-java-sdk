...
public interface ArrowReader extends Closeable {
    ...
    /**
     * Return a RecordReader that reads from this ArrowReader.
     */
    default RecordReader getAsRecordReader() {
        throw new UnsupportedOperationException("Class " + getClass().getName() + " not support getAsRecordReader() yet.");
    }
