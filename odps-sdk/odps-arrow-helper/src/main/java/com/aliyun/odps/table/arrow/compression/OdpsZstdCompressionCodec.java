...
public class OdpsZstdCompressionCodec extends AbstractCompressionCodec {

    private int compressionLevel;

    private static final int DEFAULT_COMPRESSION_LEVEL = 3;

    public OdpsZstdCompressionCodec() {
        this.compressionLevel = DEFAULT_COMPRESSION_LEVEL;
    }

    public OdpsZstdCompressionCodec(int compressionLevel) {
    ...
    protected ArrowBuf doCompress(BufferAllocator allocator, ArrowBuf uncompressedBuffer) {
        ...
        long bytesWritten =
                Zstd.compressUnsafe(
                        ...
                        // Note: fix max size for zstd compress
                        maxSize,
