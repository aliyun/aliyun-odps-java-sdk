...
public class ArrowWriterFactory {
    ...
    public static ArrowWriterFactory newBuilder(OutputStream os) {
        return new ArrowWriterFactory(os);
    }

    private OutputStream os;
    private CompressionCodec compressionCodec = CompressionCodec.NO_COMPRESSION;

    public ArrowWriterFactory(OutputStream os) {
        this.os = os;
    }

    public ArrowWriterFactory withCompression(CompressionCodec compressionCodec) {
        this.compressionCodec = compressionCodec;
        return this;
    }

    public ArrowWriter build() throws IOException {
