...
KW_MAJOR : M A J O R;
KW_MINOR: M I N O R;
KW_FREEZE: F R E E Z E;
KW_HELP : H E L P;
KW_HELP_SHORT : H;
KW_ALIAS : A L I A S;
KW_UNALIAS : U N A L I A S;
KW_QUOTA : Q U O T A;
KW_REGION : R E G I O N;
KW_EXTERNALPROJECT : E X T E R N A L P R O J E C T;
KW_LS : L S;
KW_PRIV : P R I V;
KW_COST : C O S T;
KW_PROCESSLIST : P R O C E S S L I S T;
KW_PROC : P R O C;
KW_INSTANCES : I N S T A N C E S;
KW_INSTANCE: I N S T A N C E;
