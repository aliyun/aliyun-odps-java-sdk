...
public class AppRequestSigner implements RequestSigner {
    ...
    public String getApsaraSignature(Request request) {
        String strToSign = request.getHeaders().get(Headers.AUTHORIZATION);
        return getApsaraSignature(strToSign);
    }

    public String getApsaraSignature(String strToSign) {
