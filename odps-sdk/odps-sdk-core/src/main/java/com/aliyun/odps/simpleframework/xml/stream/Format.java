...
public class Format {
   ...
   /**
    * Whether wrap the element data with a CDATA block automatically
    * if it contains characters that need to be escape.
    */
    ...
    * that is to be inserted at the start of the XML document.
    *
    * @param autoCdata this is whether wrapping the element data with
    * a CDATA block automatically
    */
    ...
    * @param style this is the style to apply to the format object
    * @param verbosity this indicates the verbosity of the format
    * @param autoCdata this is whether to wrap the element data with
    * a CDATA block automatically
    */    
   ...
   /**
    * This method is used to determine whether to wrap the element
    * data with a CDATA block automatically if it contains
    * characters that need to be escape
    *
    * @return whether to wrap the element data with a CDATA block
    * automatically
    */
