/*
 * ElementMapUnionParameter.java July 2009
 *
...
/**
 * The <code>ElementMapUnionParameter</code> represents a constructor 
...
class ElementMapUnionParameter extends TemplateParameter {
   ...
   /**   
    * Constructor for the <code>ElementMapUnionParameter</code> object.
   ...
   public ElementMapUnionParameter(Constructor factory, ElementMapUnion union, ElementMap element, Format format, int index) throws Exception {
      ...
      this.label = new ElementMapUnionLabel(contact, union, element, format);
