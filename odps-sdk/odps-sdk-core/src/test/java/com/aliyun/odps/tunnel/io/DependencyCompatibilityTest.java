...
public class DependencyCompatibilityTest {
  @Test
  public void nettyClientDecodesFragmentedResponse() {
  ...
  @Test
  public void lz4FrameRoundTrip() throws IOException {
  ...
  @Test
  public void tunnelRejectsUnknownGroupBeforeGenericProtobufParsing() throws IOException {
    ...
    try (ProtobufRecordStreamReader reader = new ProtobufRecordStreamReader(
      ...
      try {
        reader.read();
        fail("Unknown group must be rejected");
