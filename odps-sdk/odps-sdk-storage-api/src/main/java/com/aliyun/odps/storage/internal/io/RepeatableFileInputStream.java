 ...
 *
 * <p>This class extends InputStream and provides the ability to mark a position
 * and reset back to that position. It wraps a FileInputStream and uses a FileChannel
 * to manage the position marking and resetting.
 */
