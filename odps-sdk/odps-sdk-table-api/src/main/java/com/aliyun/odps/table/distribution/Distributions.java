...
public class Distributions {
    ...
    public static ClusteredDistribution clustered(List<String> clusterCols,
                                                  Distribution.Type clusterType) {
        return clustered(clusterCols, clusterType, -1);
    }

    public static ClusteredDistribution clustered(List<String> clusterCols,
                                                  Distribution.Type clusterType,
                                                  Integer bucketsNumber) {
        return new ClusteredDistribution(clusterCols, clusterType, bucketsNumber);
    }
}
